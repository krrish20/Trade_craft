...
export const chartPatterns: Pattern[] = [
    { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'head shoulders pattern' }
    },
    { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1624555130581-2d9248b4c255?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'inverse head shoulders' }
    },
    { 
        name: 'Double Top', 
        type: 'Bearish', 
        ...
        image: { src: 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'double top pattern' }
    },
    { 
        name: 'Double Bottom', 
        type: 'Bullish', 
        description: 'A reversal pattern with two consecutive troughs at roughly the same level, indicating a potential move higher.',
        image: { src: 'https://images.unsplash.com/photo-1640286599599-4a243538411a?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'double bottom pattern' }
    },
    { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1628216834553-8b78a48740f3?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'ascending triangle chart' }
    },
    { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1678248434193-f497914e4024?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'descending triangle chart' }
    },
    { 
        name: 'Bull Flag', 
        type: 'Bullish', 
        ...
        image: { src: 'https://images.unsplash.com/photo-1599658880122-ba28f6b98935?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'bull flag chart' }
    },
    { 
        name: 'Bear Flag', 
        type: 'Bearish', 
        ...
        image: { src: 'https://images.unsplash.com/photo-1639755243236-5838531758f3?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'bear flag chart' }
    },
];
...
export const candlestickPatterns: Pattern[] = [
    { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1684369175838-34828a135467?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'hammer candlestick' }
    },
    { 
        name: 'Shooting Star', 
        type: 'Bearish', 
        ...
        image: { src: 'https://images.unsplash.com/photo-1549492423-400259a5cd31?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'shooting star candlestick' }
    },
    { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1586953208448-b95a14da4492?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'bullish engulfing pattern' }
    },
    { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1509233732431-5054bee37a93?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'bearish engulfing pattern' }
    },
    { 
        name: 'Doji', 
        type: 'Neutral', 
        ...
        image: { src: 'https://images.unsplash.com/photo-1599420186946-7b6fb4e297f0?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'doji candlestick' }
    },
    { 
        name: 'Morning Star', 
        type: 'Bullish', 
        ...
        image: { src: 'https://images.unsplash.com/photo-1554672485-6a59121a4f4e?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'morning star pattern' }
    },
    { 
        name: 'Evening Star', 
        type: 'Bearish', 
        ...
        image: { src: 'https://images.unsplash.com/photo-1664335905803-3439e76a6d25?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'evening star pattern' }
    },
     { 
        ...
        image: { src: 'https://images.unsplash.com/photo-1542626991-a23188554655?q=80&w=800&h=400&auto=format&fit=crop', 'data-ai-hint': 'tweezer bottom candlestick' }
    },
];
